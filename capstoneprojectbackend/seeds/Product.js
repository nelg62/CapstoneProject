  ...
  await knex("Product").insert([
    {
      ...
      rating: 3.13,
      stock: 39,
      tags: JSON.stringify(["laptops", "apple"]),
      brand: "Apple",
      sku: "QDKO6NRJ",
      weight: 4,
      dimensions: JSON.stringify({ width: 12.38, height: 21.55, depth: 27.95 }),
    ...
    },
    {
      ...
      rating: 3.14,
      stock: 38,
      tags: JSON.stringify(["laptops"]),
      brand: "Asus",
      sku: "4A9KFMBG",
      weight: 8,
      dimensions: JSON.stringify({ width: 19.67, height: 11.05, depth: 14.32 }),
    ...
    },
    {
      ...
      sku: "U2CBNNB0",
      weight: 9,
      dimensions: JSON.stringify({ width: 22.11, height: 11.11, depth: 23.07 }),
    ...
    },
    {
      ...
      sku: "MST9WZQY",
      weight: 7,
      dimensions: JSON.stringify({ width: 11.02, height: 14.45, depth: 24.09 }),
    ...
    },
    {
      ...
      sku: "XBJJ446X",
      weight: 10,
      dimensions: JSON.stringify({ width: 12.09, height: 6.43, depth: 15.69 }),
      warrantyInformation: "Lifetime warranty",
...

    {
      ...
      rating: 3.92,
      stock: 65,
      tags: JSON.stringify(["smartphones", "apple"]),
      brand: "Apple",
      sku: "AZ1L68SM",
      weight: 4,
      dimensions: JSON.stringify({ width: 8.49, height: 25.34, depth: 18.12 }),
    ...
    },
    {
      ...
      sku: "ZPXH3X9J",
      weight: 8,
      dimensions: JSON.stringify({ width: 16.21, height: 22.94, depth: 5.63 }),
    ...
    },
    {
      ...
      sku: "YGQKHPGK",
      weight: 8,
      dimensions: JSON.stringify({ width: 22.39, height: 9.77, depth: 19.6 }),
    ...
    },
    {
      ...
      sku: "9QN3UDUD",
      weight: 10,
      dimensions: JSON.stringify({ width: 27.86, height: 8.53, depth: 17.07 }),
    ...
    },
    {
      ...
      rating: 3.1,
      stock: 76,
      tags: JSON.stringify(["smartphones", "oppo"]),
      brand: "Oppo",
      sku: "J1NO9ULG",
      weight: 3,
      dimensions: JSON.stringify({ width: 29.52, height: 11.25, depth: 14.41 }),
      warrantyInformation: "No warranty",
      shippingInformation: "Ships in 1 month",
      availabilityStatus: "In Stock",
      returnPolicy: "30 days return policy",
    ...
    },
    {
      ...
      sku: "H2TTGWXB",
      weight: 2,
      dimensions: JSON.stringify({ width: 20.35, height: 16.4, depth: 13.31 }),
      warrantyInformation: "3 year warranty",
    ...
    },
    {
      ...
      sku: "ELZ94HM3",
      weight: 2,
      dimensions: JSON.stringify({ width: 21.83, height: 27.83, depth: 27.47 }),
      warrantyInformation: "2 year warranty",
      shippingInformation: "Ships in 2 weeks",
      availabilityStatus: "In Stock",
      returnPolicy: "No return policy",
    ...
    },
    {
      ...
      rating: 2.56,
      stock: 81,
      tags: JSON.stringify(["smartphones", "realme"]),
      brand: "Realme",
      sku: "25KENV7J",
      weight: 6,
      dimensions: JSON.stringify({ width: 21.74, height: 28.75, depth: 22.22 }),
      warrantyInformation: "Lifetime warranty",
      shippingInformation: "Ships in 1 week",
      availabilityStatus: "In Stock",
      returnPolicy: "30 days return policy",
    ...
    },
    {
      ...
      sku: "5E11C5C4",
      weight: 1,
      dimensions: JSON.stringify({ width: 29.32, height: 16.3, depth: 24.12 }),
      warrantyInformation: "1 month warranty",
      shippingInformation: "Ships in 3-5 business days",
      availabilityStatus: "In Stock",
      returnPolicy: "7 days return policy",
    ...
    },
    {
      ...
      sku: "GHDMRAP2",
      weight: 4,
      dimensions: JSON.stringify({ width: 28.82, height: 23.44, depth: 6.21 }),
      warrantyInformation: "1 week warranty",
      shippingInformation: "Ships in 1 month",
      availabilityStatus: "In Stock",
      returnPolicy: "60 days return policy",
    ...
    },
    {
      ...
      rating: 4.9,
      stock: 55,
      tags: JSON.stringify(["smartphones", "samsung galaxy"]),
      brand: "Samsung",
      sku: "VZF4Z58Z",
      weight: 8,
      dimensions: JSON.stringify({ width: 23.33, height: 27.33, depth: 27.02 }),
      warrantyInformation: "1 month warranty",
      shippingInformation: "Ships in 2 weeks",
      availabilityStatus: "In Stock",
      returnPolicy: "No return policy",
    ...
    },
    {
      ...
      sku: "GLXQQKBF",
      weight: 6,
      dimensions: JSON.stringify({ width: 6.88, height: 8.96, depth: 18.13 }),
      warrantyInformation: "Lifetime warranty",
      shippingInformation: "Ships in 3-5 business days",
      availabilityStatus: "In Stock",
      returnPolicy: "No return policy",
    ...
    },
    {
      ...
      sku: "5GJFL98I",
      weight: 3,
      dimensions: JSON.stringify({ width: 28.23, height: 7.35, depth: 10.68 }),
      warrantyInformation: "1 month warranty",
      shippingInformation: "Ships overnight",
      availabilityStatus: "In Stock",
      returnPolicy: "No return policy",
    ...
    },
    {
      ...
      rating: 2.83,
      stock: 13,
      tags: JSON.stringify(["smartphones", "vivo"]),
      brand: "Vivo",
      sku: "BG6974E7",
      weight: 1,
      dimensions: JSON.stringify({ width: 28.83, height: 26.69, depth: 23.12 }),
      warrantyInformation: "1 week warranty",
      shippingInformation: "Ships overnight",
      availabilityStatus: "In Stock",
      returnPolicy: "7 days return policy",
    ...
    },
    {
      ...
      sku: "N9WFE2WH",
      weight: 5,
      dimensions: JSON.stringify({ width: 27.29, height: 9.73, depth: 14.79 }),
      warrantyInformation: "1 week warranty",
      shippingInformation: "Ships overnight",
      availabilityStatus: "In Stock",
      returnPolicy: "No return policy",
    ...
    },
    {
      ...
      sku: "KSF00BOC",
      weight: 7,
      dimensions: JSON.stringify({ width: 5.72, height: 16.47, depth: 27.76 }),
      warrantyInformation: "1 week warranty",
      shippingInformation: "Ships overnight",
